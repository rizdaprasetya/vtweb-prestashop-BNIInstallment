  ...
  <legend><img src="../img/admin/contact.gif" />Basic Information</legend>
    <table border="0" id="form">
      ...
      <!-- <tr>
        ...
        <td>
          <select name="VN_API_VERSION" id="veritransApiVersion">
      ...
      <input type="hidden" name="VN_API_VERSION" value="2">
      <!-- API VERSION -->

      <!-- <tr>
        <td width="300" style="vertical-align: top;">Payment Type</td>
        <td>
          <select name="VN_PAYMENT_TYPE" id="veritransPaymentType">
      ...
      <!-- <tr class="v1_vtweb_settings sensitive">
        ...
        <td><input type="text" name="VN_MERCHANT_ID" value="{$merchant_id}" style="width: 300px;" /></td>
      </tr> -->
      <!-- MERCHANT_ID -->

      <!-- <tr class="v1_vtweb_settings sensitive">
        <td width="300" style="vertical-align: top;">Merchant Hash</td>
        <td><input type="text" name="VN_MERCHANT_HASH" value="{$merchant_hash_key}" style="width: 300px;" /></td>
      </tr> -->
      <!-- MERCHANT_HASH -->

      <tr class="v1_vtdirect_settings v2_settings">
        <td width="300" style="vertical-align: top;">Server Key</td>
        <td><input type="text" name="VN_SERVER_KEY" value="{$server_key}" style="width: 300px;" /></td>
      </tr>
      <!-- SERVER_KEY -->
      ...
      <input type="hidden" name="VN_PAYMENT_TYPE" value="vtweb">
      <!-- PAYMENT_TYPE -->

      <tr>
        <td width="300" style="vertical-align: top;">Map Payment Success to Status:</td>
        <td>
          <select name="VN_PAYMENT_SUCCESS_STATUS_MAP">
      ...
      <tr>
        ...
        <td>
          <select name="VN_PAYMENT_CHALLENGE_STATUS_MAP">
            {foreach from=$statuses item=v}
      ...
      <tr>
        ...
        <td>
          <select name="VN_PAYMENT_FAILURE_STATUS_MAP">
            {foreach from=$statuses item=v}
      ...
      <tr>
        ...
        <td><input type="text" name="VN_KURS" value="{$kurs}" style="width: 300px;" /></td>
      </tr>
      <!-- KURS -->
