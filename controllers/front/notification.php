...
class VeritransBniNotificationModuleFrontController extends ModuleFrontController
{
  /**
  ...
  { 
    ...
    //     { 
    //       // $this->module->validateOrder($cart->id, Configuration::get('VN_PAYMENT_SUCCESS_STATUS_MAP'), $total, $this->module->displayName, NULL, $mailVars, (int)$currency->id, false, $customer->secure_key);     
    //       $history->changeIdOrderState(Configuration::get('VN_PAYMENT_SUCCESS_STATUS_MAP'), (int)$veritrans_notification->orderId);
    ...
    //     {
    //       // $this->module->validateOrder($cart->id, Configuration::get('VN_PAYMENT_FAILURE_STATUS_MAP'), $total, $this->module->displayName, NULL, $mailVars, (int)$currency->id, false, $customer->secure_key);
    //       $history->changeIdOrderState(Configuration::get('VN_PAYMENT_SUCCESS_FAILURE_MAP'), (int)$veritrans_notification->orderId);
